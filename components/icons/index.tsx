...
// Using React.SVGProps for better type safety with SVG attributes
...
export const PencilSquareIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        ...
        <path strokeLinecap="round" strokeLinejoin="round" d="M9.75 8.25H4.5a2.25 2.25 0 0 0-2.25 2.25v11.25c0 1.24 1.01 2.25 2.25 2.25h11.25c1.24 0 2.25-1.01 2.25-2.25V13.5" />
    </svg>
);
